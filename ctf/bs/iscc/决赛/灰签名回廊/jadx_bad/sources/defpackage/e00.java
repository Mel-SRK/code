...
public abstract class e00 {
    ...
    */
    public static final float i(kf0 kf0Var, boolean z, tx[] txVarArr, float f2) {
        float f3 = Float.NaN;
        for (tx txVar : txVarArr) {
            float fD = kf0Var.d(txVar);
            if (Float.isNaN(f3)) {
                f3 = fD;
            } else if (z == (fD > f3)) {
            }
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public static final Object y(yr yrVar, gv gvVar, ki kiVar) {
        is isVar;
        ?? r1;
        xi0 xi0Var;
        a e2;
        ...
        ?? r12;
        jq jqVar = m10.d;
        if (kiVar instanceof is) {
            isVar = (is) kiVar;
            int i2 = isVar.k;
            if ((i2 & Integer.MIN_VALUE) != 0) {
                isVar.k = i2 - Integer.MIN_VALUE;
            } else {
                isVar = new is(kiVar);
            }
        }
        ...
        if (i3 == 0) {
            ...
            xi0 xi0Var2 = new xi0();
            xi0Var2.d = jqVar;
            in inVar2 = new in(gvVar, xi0Var2);
            try {
                isVar.g = (tt0) gvVar;
                isVar.h = xi0Var2;
                isVar.i = inVar2;
                isVar.k = 1;
                Object objB = yrVar.b(inVar2, isVar);
                yj yjVar = yj.d;
                if (objB == yjVar) {
                    return yjVar;
                }
