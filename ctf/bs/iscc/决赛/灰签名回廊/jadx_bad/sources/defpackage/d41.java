...
public abstract class d41 {
    ...
    */
    public static final boolean ah(gt gtVar) {
        a90 a90Var;
        int i2;
        int length;
        da0 da0Var;
        char c2;
        da0 da0Var2;
        us usVar = (us) pk.az(gtVar).getFocusOwner();
        gt gtVar2 = usVar.h;
        et etVarBx = gtVar.bx();
        if (gtVar2 == gtVar) {
            gtVar.bu(etVarBx, etVarBx);
            return true;
        }
        int i3 = 0;
        if (gtVar2 == null && !((us) pk.az(gtVar).getFocusOwner()).a.ab()) {
            return false;
        }
        char c3 = 16;
        if (gtVar2 != null) {
            a90Var = new a90(new gt[16]);
            if (!gtVar2.d.q) {
                sy.b("visitAncestors called on an unattached node");
            }
            i70 i70Var = gtVar2.d.h;
            s20 s20VarAy = pk.ay(gtVar2);
            while (s20VarAy != null) {
                if ((((i70) s20VarAy.ag.j).g & 1024) != 0) {
                    while (i70Var != null) {
                        if ((i70Var.f & 1024) != 0) {
                ...
                s20VarAy = s20VarAy.q();
                i70Var = (s20VarAy == null || (da0Var2 = s20VarAy.ag) == null) ? null : (hu0) da0Var2.i;
            }
        } else {
            a90Var = null;
        }
        ...
        i70 i70Var3 = gtVar.d.h;
        s20 s20VarAy2 = pk.ay(gtVar);
        int i5 = 1;
        int i6 = 0;
        while (s20VarAy2 != null) {
            if ((((i70) s20VarAy2.ag.j).g & 1024) != 0) {
                while (i70Var3 != null) {
                    if ((i70Var3.f & 1024) != 0) {
                        i70 i70VarM2 = i70Var3;
                        a90 a90Var3 = null;
                        while (i70VarM2 != null) {
                            if (i70VarM2 instanceof gt) {
                                gt gtVar3 = (gt) i70VarM2;
                                Boolean boolValueOf = a90Var != null ? Boolean.valueOf(a90Var.i(gtVar3)) : null;
                                if (boolValueOf == null || !boolValueOf.booleanValue()) {
                                    int i7 = i6 + 1;
                                    if (objArr.length < i7) {
                                        int length2 = objArr.length;
                                        Object[] objArr2 = new Object[Math.max(i7, length2 * 2)];
                                        System.arraycopy(objArr, i3, objArr2, i3, length2);
                                        objArr = objArr2;
                                    }
                                    objArr[i6] = gtVar3;
                                    i6 = i7;
                                ...
                                if ((i70VarM2.f & 1024) != 0 && (i70VarM2 instanceof rl)) {
                                    int i8 = i3;
                                    for (i70 i70Var4 = ((rl) i70VarM2).s; i70Var4 != null; i70Var4 = i70Var4.i) {
                                        if ((i70Var4.f & 1024) != 0) {
                                            i8++;
                                            if (i8 == 1) {
                                                i70VarM2 = i70Var4;
            ...
            i70Var3 = (s20VarAy2 == null || (da0Var = s20VarAy2.ag) == null) ? null : (hu0) da0Var.i;
            c3 = c4;
            i3 = 0;
        }
        if (i5 == 0 || gtVar2 == null || q(gtVar2, false)) {
            az0.z(gtVar, new b(8, gtVar));
            int iOrdinal = gtVar.bx().ordinal();
            if (iOrdinal != 0) {
                if (iOrdinal == 1) {
                    ((us) pk.az(gtVar).getFocusOwner()).g(gtVar);
                } else if (iOrdinal != 2) {
                    if (iOrdinal != 3) {
                        wc.l();
                        return false;
            ...
            if (a90Var != null) {
                int i9 = a90Var.f - 1;
                Object[] objArr3 = a90Var.d;
                if (i9 < objArr3.length) {
                    while (i9 >= 0) {
                        gt gtVar4 = (gt) objArr3[i9];
                        if (usVar.h != gtVar) {
                            break;
                        }
                        gtVar4.bu(etVar2, etVar);
                        i9--;
                    }
                    i2 = i6 - 1;
                    ...
                    if (i2 >= length) {
                        while (i2 >= 0) {
                            gt gtVar5 = (gt) objArr[i2];
                            if (usVar.h != gtVar) {
                                break;
                            }
                            gtVar5.bu(gtVar5 == gtVar2 ? etVar3 : etVar, etVar2);
                            i2--;
                        }
                        if (usVar.h == gtVar) {
                            gtVar.bu(etVarBx, etVar3);
                            if (usVar.h != gtVar) {
                                break;
                            }
                            return true;
                        }
                    } else if (usVar.h == gtVar) {
                    }
                } else {
                    i2 = i6 - 1;
                    length = objArr.length;
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public static final void f(String str, j70 j70Var, nx0 nx0Var, int i2, boolean z, int i3, int i4, vf vfVar, int i5, int i6) {
        int i7;
        nx0 nx0Var2;
        int i8;
        int i9;
        ...
        vfVar.aw(-1186827822);
        if ((i5 & 6) == 0) {
            i7 = (vfVar.f(str) ? 4 : 2) | i5;
        } else {
            i7 = i5;
        }
        if ((i5 & 48) == 0) {
            i7 |= vfVar.f(j70Var) ? 32 : 16;
        }
        if ((i5 & 384) == 0) {
            nx0Var2 = nx0Var;
            i7 |= vfVar.f(nx0Var2) ? 256 : 128;
        } else {
            nx0Var2 = nx0Var;
        }
        if ((i6 & 8) != 0) {
        ...
        if (i14 != 0) {
            ...
            if (i9 == 0) {
                ...
                if ((196608 & i5) == 0) {
                    z2 = z;
                    i7 |= vfVar.g(z2) ? 131072 : 65536;
                }
                if ((1572864 & i5) == 0) {
                    i7 |= vfVar.d(i3) ? 1048576 : 524288;
                }
                i10 = i6 & 128;
                if (i10 == 0) {
                    if ((12582912 & i5) == 0) {
                        i11 = i4;
                        i7 |= vfVar.d(i11) ? 8388608 : 4194304;
                    }
                    if (((i7 | 100663296) & 38347923) == 38347922 || !vfVar.z()) {
                        int i15 = i14 == 0 ? 1 : i8;
                        if (i9 != 0) {
                            z2 = true;
                        }
                        ...
                        vfVar.av(-1587866335);
                        boolean z4 = z2;
                        j70 j70VarC = androidx.compose.ui.graphics.a.a(j70Var, 0.0f, null, 131071).c(new TextStringSimpleElement(str, nx0Var2, (qt) vfVar.j(og.k), i15, z4, i3, i16));
                        vfVar.q(false);
                        f4 f4Var = f4.d;
                    ...
                    hi0VarS = vfVar.s();
                    if (hi0VarS == null) {
                        hi0VarS.d = new x7(str, j70Var, nx0Var, i12, z3, i3, i13, i5, i6);
                        return;
                    }
                    return;
                }
                i7 |= 12582912;
                i11 = i4;
                if (((i7 | 100663296) & 38347923) == 38347922) {
                    if (i14 == 0) {
                    }
                    if (i9 != 0) {
                    }
