...
public abstract class fa0 extends j50 implements k60, d20, sd0 {
    ...
    */
    public final void R(i70 i70Var, n31 n31Var, long j, px pxVar, int i, boolean z, float f, boolean z2) {
        ?? M;
        boolean z3;
        int i2;
        if (i70Var == null) {
        ...
        if (i3 == 3 || i3 == 4) {
            ...
            while (true) {
                ...
                if (r8 instanceof sg0) {
                    long jR = ((sg0) r8).r();
                    int i4 = (int) (j >> 32);
                    float fIntBitsToFloat = Float.intBitsToFloat(i4);
                    s20 s20Var = this.r;
                    e20 e20Var = s20Var.aa;
                    int i5 = dy0.b;
                    long j2 = jR & Long.MIN_VALUE;
                    e20 e20Var2 = e20.d;
                    if (fIntBitsToFloat >= (-((j2 == 0 || e20Var == e20Var2) ? yf0.b(jR, 0) : yf0.b(jR, 2)))) {
                        if (Float.intBitsToFloat(i4) < az() + ((j2 == 0 || s20Var.aa == e20Var2) ? yf0.b(jR, 2) : yf0.b(jR, 0))) {
                            int i6 = (int) (j & 4294967295L);
                            if (Float.intBitsToFloat(i6) >= (-yf0.b(jR, 1))) {
                                if (Float.intBitsToFloat(i6) < yf0.b(jR, 3) + ay()) {
                                    h80 h80Var = pxVar.e;
                                    m80 m80Var = pxVar.d;
                                    int i7 = pxVar.f;
                                    int i8 = m80Var.b;
                                    if (i7 == i8 - 1) {
                                        ...
                                        pxVar.f++;
                                        m80Var.a(i70Var);
                                        h80Var.a(e00.d(0.0f, z, true));
                                        R(i60.h(i70Var, n31Var.f()), n31Var, j, pxVar, i3, z, f, z2);
                                        pxVar.f = i7;
                                        return;
                                    }
                                    long jA = pxVar.a();
                                    ...
                                    if (!m10.ag(jA)) {
                                        if (m10.x(jA) > 0.0f) {
                                            int i10 = pxVar.f;
                                            pxVar.b(i10 + 1, m80Var.b);
                                            pxVar.f++;
                                            m80Var.a(i70Var);
                                            h80Var.a(e00.d(0.0f, z, true));
                                            R(i60.h(i70Var, n31Var.f()), n31Var, j, pxVar, i, z, f, z2);
                                            pxVar.f = i10;
                                            return;
                                        }
                                        return;
                                    ...
                                    int i12 = i11 - 1;
                                    pxVar.f = i12;
                                    pxVar.b(i11, m80Var.b);
                                    pxVar.f++;
                                    m80Var.a(i70Var);
                                    h80Var.a(e00.d(0.0f, z, true));
                                    R(i60.h(i70Var, n31Var.f()), n31Var, j, pxVar, i, z, f, z2);
                                    pxVar.f = i12;
                                    if (m10.x(pxVar.a()) < 0.0f) {
                                        pxVar.b(i9 + 1, pxVar.f + 1);
                                    }
                                    pxVar.f = i9;
                                    return;
                                }
        ...
        if (!z3) {
            R(i60.h(i70Var, n31Var.f()), n31Var, j, pxVar, i, z, f, false);
            return;
        }
        h80 h80Var2 = pxVar.e;
        m80 m80Var2 = pxVar.d;
        ...
        if (i16 != i17 - 1) {
            ...
            int i20 = i19 - 1;
            pxVar.f = i20;
            pxVar.b(i19, m80Var2.b);
            pxVar.f++;
            m80Var2.a(i70Var);
            h80Var2.a(e00.d(f, z, false));
            R(i60.h(i70Var, n31Var.f()), n31Var, j, pxVar, i, z, f, false);
            pxVar.f = i20;
            long jA3 = pxVar.a();
            if (pxVar.f + 1 >= m80Var2.b - 1 || m10.o(jA2, jA3) <= 0) {
                pxVar.b(pxVar.f + 1, m80Var2.b);
            } else {
                int i21 = i18 + 1;
                boolean zAg = m10.ag(jA3);
                int i22 = pxVar.f;
                pxVar.b(i21, zAg ? i22 + 2 : i22 + 1);
            }
            pxVar.f = i18;
            return;
        }
        ...
        R(i60.h(i70Var, n31Var.f()), n31Var, j, pxVar, i, z, f, false);
        pxVar.f = i16;
        if (i23 == m80Var2.b - 1 || m10.ag(pxVar.a())) {
            int i24 = pxVar.f;
            int i25 = i24 + 1;
            m80Var2.j(i25);
            if (i25 < 0 || i25 >= (i2 = h80Var2.b)) {
    ...
    */
    public final boolean e0(long j) {
        ...
        rd0 rd0Var = this.al;
        if (rd0Var == null || !this.v) {
            return true;
        }
        float fIntBitsToFloat = Float.intBitsToFloat((int) (j >> 32));
        float fIntBitsToFloat2 = Float.intBitsToFloat((int) (j & 4294967295L));
        jw jwVar = ((lw) rd0Var).d;
        if (jwVar.w) {
            bd0 bd0VarD = jwVar.d();
            if (bd0VarD instanceof zc0) {
                ri0 ri0Var = ((zc0) bd0VarD).a;
                if (ri0Var.a > fIntBitsToFloat || fIntBitsToFloat >= ri0Var.c || ri0Var.b > fIntBitsToFloat2 || fIntBitsToFloat2 >= ri0Var.d) {
                    z = false;
                    z2 = true;
                }
                z = false;
                        ...
                        if (Float.intBitsToFloat(i4) + fIntBitsToFloat4 <= f - f4) {
                            ...
                            if (Float.intBitsToFloat(i6) + Float.intBitsToFloat(i5) <= f3 - f2) {
                                ...
                                if (Float.intBitsToFloat(i8) + Float.intBitsToFloat(i7) <= f3 - f2) {
                                    ...
                                    zK = (fIntBitsToFloat >= fIntBitsToFloat5 || fIntBitsToFloat2 >= fIntBitsToFloat6) ? (fIntBitsToFloat >= fIntBitsToFloat12 || fIntBitsToFloat2 <= fIntBitsToFloat11) ? (fIntBitsToFloat <= fIntBitsToFloat7 || fIntBitsToFloat2 >= fIntBitsToFloat8) ? (fIntBitsToFloat <= fIntBitsToFloat9 || fIntBitsToFloat2 <= fIntBitsToFloat10) ? z2 : go0.k(fIntBitsToFloat, fIntBitsToFloat2, fIntBitsToFloat9, fIntBitsToFloat10, yk0Var.g) : go0.k(fIntBitsToFloat, fIntBitsToFloat2, fIntBitsToFloat7, fIntBitsToFloat8, yk0Var.f) : go0.k(fIntBitsToFloat, fIntBitsToFloat2, fIntBitsToFloat12, fIntBitsToFloat11, yk0Var.h) : go0.k(fIntBitsToFloat, fIntBitsToFloat2, fIntBitsToFloat5, fIntBitsToFloat6, yk0Var.e);
                                } else {
                                    t3 t3VarA = u3.a();
                                    t3.a(t3VarA, yk0Var);
                                    zK = go0.i(t3VarA, fIntBitsToFloat, fIntBitsToFloat2);
                                }
                            }
                        }
                    }
                ...
                zK = go0.i(((yc0) bd0VarD).a, fIntBitsToFloat, fIntBitsToFloat2);
            }
            zK = z;
        } else {
            z = false;
