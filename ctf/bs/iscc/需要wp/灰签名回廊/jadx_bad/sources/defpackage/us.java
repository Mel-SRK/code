...
public final class us implements ss {
    ...
    */
    public final boolean d(KeyEvent keyEvent, pu puVar) {
        Object obj;
        i70 i70Var;
        da0 da0Var;
        Object obj2;
        ...
        try {
            ...
            if (gtVarO != null) {
                ...
                i70 i70Var2 = gtVarO.d;
                if ((i70Var2.g & 9216) != 0) {
                    i70Var = null;
                    for (i70 i70Var3 = i70Var2.i; i70Var3 != null; i70Var3 = i70Var3.i) {
                        int i = i70Var3.f;
                        if ((i & 9216) != 0) {
                            if ((i & 1024) != 0) {
                                break;
                ...
                loop15: while (true) {
                    ...
                    if ((((i70) s20VarAy.ag.j).g & 8192) != 0) {
                        while (i70Var4 != null) {
                            if ((i70Var4.f & 8192) != 0) {
                                i70 i70VarM = i70Var4;
                                a90 a90Var = null;
                                while (i70VarM != null) {
                                    if (i70VarM instanceof o10) {
                                        obj = i70VarM;
                                        break loop15;
                                    }
                                    if ((i70VarM.f & 8192) != 0 && (i70VarM instanceof rl)) {
                                        i70 i70Var5 = ((rl) i70VarM).s;
                                        int i2 = 0;
                                        i70VarM = i70VarM;
                                        a90Var = a90Var;
                                        while (i70Var5 != null) {
                    ...
                    s20VarAy = s20VarAy.q();
                    i70Var4 = (s20VarAy == null || (da0Var = s20VarAy.ag) == null) ? null : (hu0) da0Var.i;
                }
                Object obj3 = (o10) obj;
                i70Var = obj3 != null ? ((i70) obj3).d : null;
            } else {
                if (!gtVarO.d.q) {
                    sy.b("visitAncestors called on an unattached node");
                }
                i70 i70Var6 = gtVarO.d;
                s20 s20VarAy2 = pk.ay(gtVarO);
                loop11: while (true) {
                    if (s20VarAy2 == null) {
                        obj2 = null;
                        break;
                    }
                    if ((((i70) s20VarAy2.ag.j).g & 8192) != 0) {
                        while (i70Var6 != null) {
                            if ((i70Var6.f & 8192) != 0) {
                                a90 a90Var2 = null;
                                i70 i70VarM2 = i70Var6;
                                while (i70VarM2 != null) {
                                    if (i70VarM2 instanceof o10) {
                                        obj2 = i70VarM2;
                                        break loop11;
                                    }
                                    if ((i70VarM2.f & 8192) != 0 && (i70VarM2 instanceof rl)) {
                                        i70 i70Var7 = ((rl) i70VarM2).s;
                                        int i3 = 0;
                                        i70VarM2 = i70VarM2;
                                        a90Var2 = a90Var2;
                                        while (i70Var7 != null) {
                    ...
                    i70Var6 = (s20VarAy2 == null || (da0Var2 = s20VarAy2.ag) == null) ? null : (hu0) da0Var2.i;
                }
                Object obj4 = (o10) obj2;
                if (obj4 != null) {
                    i70Var = ((i70) obj4).d;
                }
            }
            if (i70Var != null) {
                ...
                i70 i70Var8 = i70Var.d.h;
                s20 s20VarAy3 = pk.ay(i70Var);
                ArrayList arrayList = null;
                while (s20VarAy3 != null) {
                    if ((((i70) s20VarAy3.ag.j).g & 8192) != 0) {
                        while (i70Var8 != null) {
                            if ((i70Var8.f & 8192) != 0) {
                                i70 i70VarM3 = i70Var8;
                                a90 a90Var3 = null;
                                while (i70VarM3 != null) {
                                    if (i70VarM3 instanceof o10) {
                                        if (arrayList == null) {
                                            arrayList = new ArrayList();
                                        }
                                        arrayList.add(i70VarM3);
                                    } else if ((i70VarM3.f & 8192) != 0 && (i70VarM3 instanceof rl)) {
                                        int i4 = 0;
                                        for (i70 i70Var9 = ((rl) i70VarM3).s; i70Var9 != null; i70Var9 = i70Var9.i) {
                                            if ((i70Var9.f & 8192) != 0) {
                                                i4++;
                                                if (i4 == 1) {
                                                    i70VarM3 = i70Var9;
                    ...
                    i70Var8 = (s20VarAy3 == null || (da0Var3 = s20VarAy3.ag) == null) ? null : (hu0) da0Var3.i;
                }
                if (arrayList != null && arrayList.size() - 1 >= 0) {
                    while (true) {
                        int i5 = size - 1;
                        if (((o10) arrayList.get(size)).j(keyEvent)) {
                            return true;
                        }
                        if (i5 < 0) {
                            break;
                ...
                while (M != 0) {
                    ...
                    } else if ((M.f & 8192) != 0 && (M instanceof rl)) {
                        i70 i70Var10 = ((rl) M).s;
                        int i6 = 0;
                        M = M;
                        a90Var4 = a90Var4;
                        while (i70Var10 != null) {
                            if ((i70Var10.f & 8192) != 0) {
                                i6++;
                                a90Var4 = a90Var4;
                                if (i6 == 1) {
                                    M = i70Var10;
                ...
                if (((Boolean) puVar.a()).booleanValue()) {
                    return true;
                }
                ?? M2 = i70Var.d;
                ?? a90Var5 = 0;
                while (M2 != 0) {
                    if (M2 instanceof o10) {
                        if (((o10) M2).al(keyEvent)) {
                            return true;
                        }
                    } else if ((M2.f & 8192) != 0 && (M2 instanceof rl)) {
                        i70 i70Var11 = ((rl) M2).s;
                        int i7 = 0;
                        a90Var5 = a90Var5;
                        M2 = M2;
                        while (i70Var11 != null) {
                            if ((i70Var11.f & 8192) != 0) {
                                i7++;
                                a90Var5 = a90Var5;
                                if (i7 == 1) {
                                    M2 = i70Var11;
                ...
                if (arrayList != null) {
                    ...
                    for (int i8 = 0; i8 < size2; i8++) {
                        if (((o10) arrayList.get(i8)).al(keyEvent)) {
                            return true;
                        }
                    }
                }
    ...
    */
    public final boolean h(KeyEvent keyEvent) {
        ...
        if (iAd == 2) {
            ...
            j80 j80Var2 = j80Var;
            int iHashCode = Long.hashCode(jAa) * (-862048943);
            ...
            loop0: while (true) {
                ...
                int i11 = i;
                int i12 = (i8 & 7) << 3;
                long j3 = (jArr[i10] >>> i12) | ((jArr[i10 + 1] << (64 - i12)) & ((-i12) >> 63));
                long j4 = i6;
                ...
                while (true) {
                    ...
                    iNumberOfTrailingZeros2 = (i8 + (Long.numberOfTrailingZeros(j6) >> 3)) & i7;
                    long j7 = j2;
                    if (j80Var2.b[iNumberOfTrailingZeros2] == jAa) {
                        z = true;
                        break loop0;
                    }
                    j6 &= j6 - 1;
            ...
            j80Var2.b[iNumberOfTrailingZeros2] = jAa;
            return z;
        }
        if (iAd != 1) {
            return true;
        ...
        j80 j80Var3 = this.f;
        if (j80Var3 == null || !j80Var3.a(jAa)) {
            return false;
        }
        j80 j80Var4 = this.f;
        if (j80Var4 != null) {
            int iHashCode2 = Long.hashCode(jAa) * (-862048943);
            ...
            loop5: while (true) {
                int i17 = i16 & i15;
                long[] jArr2 = j80Var4.a;
                int i18 = i17 >> 3;
                int i19 = (i17 & 7) << 3;
                long j8 = ((jArr2[i18 + 1] << (64 - i19)) & ((-i19) >> 63)) | (jArr2[i18] >>> i19);
                long j9 = (((long) i14) * 72340172838076673L) ^ j8;
                long j10 = (~j9) & (j9 - 72340172838076673L) & (-9187201950435737472L);
                while (true) {
                    if (j10 == 0) {
                        break;
                    }
                    iNumberOfTrailingZeros = ((Long.numberOfTrailingZeros(j10) >> 3) + i17) & i15;
                    if (j80Var4.b[iNumberOfTrailingZeros] == jAa) {
                        break loop5;
                    }
                    j10 &= j10 - 1;
                }
            ...
            if (iNumberOfTrailingZeros >= 0) {
                j80Var4.d--;
                long[] jArr3 = j80Var4.a;
                int i20 = j80Var4.c;
                int i21 = iNumberOfTrailingZeros >> 3;
                int i22 = (iNumberOfTrailingZeros & 7) << 3;
                long j11 = (jArr3[i21] & (~(255 << i22))) | (254 << i22);
                jArr3[i21] = j11;
                jArr3[(((iNumberOfTrailingZeros - 7) & i20) + (i20 & 7)) >> 3] = j11;
                return true;
            }
        }
        return true;
