...
public final class w30 extends p30 {
    ...
    */
    public final void g() {
        u30 u30Var = (u30) this.d.get();
        if (u30Var == null) {
            wc.q("LifecycleOwner of this LifecycleRegistry is already garbage collected. It is too late to change lifecycle state.");
            return;
        }
        while (true) {
            hr hrVar = this.b;
            if (hrVar.g != 0) {
                nl0 nl0Var = hrVar.d;
                nl0Var.getClass();
                o30 o30Var = nl0Var.e.a;
                nl0 nl0Var2 = this.b.e;
                nl0Var2.getClass();
                o30 o30Var2 = nl0Var2.e.a;
                if (o30Var == o30Var2 && this.c == o30Var2) {
                    break;
                }
                this.g = false;
                o30 o30Var3 = this.c;
                nl0 nl0Var3 = this.b.d;
                nl0Var3.getClass();
                int iCompareTo = o30Var3.compareTo(nl0Var3.e.a);
                ArrayList arrayList = this.h;
                if (iCompareTo < 0) {
                    hr hrVar2 = this.b;
                    ml0 ml0Var = new ml0(hrVar2.e, hrVar2.d, 1);
                    hrVar2.f.put(ml0Var, Boolean.FALSE);
                    while (ml0Var.hasNext() && !this.g) {
                        Map.Entry entry = (Map.Entry) ml0Var.next();
                        entry.getClass();
                        t30 t30Var = (t30) entry.getKey();
                        v30 v30Var = (v30) entry.getValue();
                        while (v30Var.a.compareTo(this.c) > 0 && !this.g && this.b.h.containsKey(t30Var)) {
                            l30 l30Var = n30.Companion;
                            o30 o30Var4 = v30Var.a;
                            l30Var.getClass();
                            o30Var4.getClass();
                            int iOrdinal = o30Var4.ordinal();
                            n30 n30Var = iOrdinal != 2 ? iOrdinal != 3 ? iOrdinal != 4 ? null : n30.ON_PAUSE : n30.ON_STOP : n30.ON_DESTROY;
                            if (n30Var == null) {
                                wc.m(v30Var.a, "no event down from ");
                                return;
                            } else {
                                arrayList.add(n30Var.a());
                                v30Var.a(u30Var, n30Var);
                                arrayList.remove(arrayList.size() - 1);
                            }
                        }
                    }
                }
                nl0 nl0Var4 = this.b.e;
                if (!this.g && nl0Var4 != null && this.c.compareTo(nl0Var4.e.a) > 0) {
                    hr hrVar3 = this.b;
                    hrVar3.getClass();
                    ol0 ol0Var = new ol0(hrVar3);
                    hrVar3.f.put(ol0Var, Boolean.FALSE);
                    while (ol0Var.hasNext() && !this.g) {
                        Map.Entry entry2 = (Map.Entry) ol0Var.next();
                        t30 t30Var2 = (t30) entry2.getKey();
                        v30 v30Var2 = (v30) entry2.getValue();
                        while (v30Var2.a.compareTo(this.c) < 0 && !this.g && this.b.h.containsKey(t30Var2)) {
                            arrayList.add(v30Var2.a);
                            l30 l30Var2 = n30.Companion;
                            o30 o30Var5 = v30Var2.a;
                            l30Var2.getClass();
                            o30Var5.getClass();
                            int iOrdinal2 = o30Var5.ordinal();
                            n30 n30Var2 = iOrdinal2 != 1 ? iOrdinal2 != 2 ? iOrdinal2 != 3 ? null : n30.ON_RESUME : n30.ON_START : n30.ON_CREATE;
                            if (n30Var2 == null) {
                                wc.m(v30Var2.a, "no event up from ");
                                return;
                            } else {
                                v30Var2.a(u30Var, n30Var2);
                                arrayList.remove(arrayList.size() - 1);
                            }
                        }
                    }
