...
public abstract class f00 {
    ...
    */
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public static final Object j(yt0 yt0Var, s7 s7Var) {
        lu luVar;
        yj yjVar;
        int size;
        int i2;
        if (s7Var instanceof lu) {
            luVar = (lu) s7Var;
            int i3 = luVar.i;
            if ((i3 & Integer.MIN_VALUE) != 0) {
                luVar.i = i3 - Integer.MIN_VALUE;
            } else {
                luVar = new lu(s7Var);
            }
        }
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public static final Object s(zr zrVar, oh0 oh0Var, boolean z, ki kiVar) {
        cs csVar;
        n9 it;
        ?? r8;
        n9 n9Var;
        zr zrVar2;
        Object objB;
        if (kiVar instanceof cs) {
            csVar = (cs) kiVar;
            int i2 = csVar.l;
            if ((i2 & Integer.MIN_VALUE) != 0) {
                csVar.l = i2 - Integer.MIN_VALUE;
            } else {
                csVar = new cs(kiVar);
            }
        }
