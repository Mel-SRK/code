...
public final class f40 implements LineHeightSpan {
    ...
    public f40(float f, int i, boolean z, boolean z2, float f2, boolean z3) {
        this.d = f;
        this.e = i;
        this.f = z;
        this.g = z2;
        ...
        if ((0.0f > f2 || f2 > 1.0f) && f2 != -1.0f) {
            ty.b("topRatio should be in [0..1] range or -1");
        }
    }
